...
```{r save_plots}
ggsave("strategies1.png",strategies1)
ggsave("strategies2.png",strategies2)
ggsave("strategies3.png",strategies3)



ggsave("int1.png", int1)
ggsave("int2.png", int2)
ggsave("int3.png", int3)

ggsave("static1.png", static1)
ggsave("static2.png", static2)
ggsave("static3.png", static3)

ggsave("paper1.png", paper1)
ggsave("paper2.png", paper2)
ggsave("paper3.png", paper3)
